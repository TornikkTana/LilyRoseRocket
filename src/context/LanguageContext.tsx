...
const translations: Record<Language, Record<string, string>> = {
  ka: {
    ...
    'cart.payOnline': 'გადახდა ბარათით',
    'cart.payOnlineBtn': 'გადახდა ონლაინ',
    'cart.whatsappBtn': 'შეკვეთა WhatsApp-ით',
    'modal.paymentProcessing': 'მიმდინარეობს გადახდის ინიცირება...',
    'result.success.title': 'გადახდა წარმატებულია!',
    'result.success.desc': 'გმადლობთ შეკვეთისთვის! თქვენი თაიგულის დამზადება დაიწყო.',
    'result.failed.title': 'გადახდა ვერ მოხერხდა',
    'result.failed.desc': 'გთხოვთ სცადოთ თავიდან ან აირჩიოთ სხვა ბარათი.',
    'result.backHome': 'მთავარზე დაბრუნება',
    'result.checkingStatus': 'მიმდინარეობს გადახდის სტატუსის შემოწმება...',
    'result.orderId': 'შეკვეთის ID',
    'result.totalPaid': 'გადახდილი თანხა',
    'result.status': 'სტატუსი',
    'result.status.Succeeded': 'წარმატებული',
    'result.status.Failed': 'ვერ მოხერხდა',
    'result.status.Pending': 'მოლოდინში',
    'result.status.Expired': 'ვადაგასული',
  ...
  en: {
    ...
    'cart.payOnline': 'Pay with Card',
    'cart.payOnlineBtn': 'Pay Online',
    'cart.whatsappBtn': 'Order via WhatsApp',
    'modal.paymentProcessing': 'Initiating payment...',
    'result.success.title': 'Payment Successful!',
    'result.success.desc': 'Thank you for your order! We have started preparing your bouquet.',
    'result.failed.title': 'Payment Failed',
    'result.failed.desc': 'Please try again or use a different card.',
    'result.backHome': 'Back to Home',
    'result.checkingStatus': 'Checking payment status...',
    'result.orderId': 'Order ID',
    'result.totalPaid': 'Total Paid',
  ...
  ru: {
    ...
    'cart.payOnline': 'Оплата картой',
    'cart.payOnlineBtn': 'Оплатить онлайн',
    'cart.whatsappBtn': 'Заказать в WhatsApp',
    'modal.paymentProcessing': 'Инициализация оплаты...',
    'result.success.title': 'Оплата успешна!',
    'result.success.desc': 'Спасибо за заказ! Мы начали готовить ваш букет.',
    'result.failed.title': 'Ошибка оплаты',
    'result.failed.desc': 'Пожалуйста, попробуйте еще раз или используйте другую карту.',
    'result.backHome': 'На главную',
    'result.checkingStatus': 'Проверка статуса оплаты...',
    'result.orderId': 'ID заказа',
    'result.totalPaid': 'Оплачено',
    'result.status': 'Статус',
    'result.status.Succeeded': 'Успешно',
    'result.status.Failed': 'Ошибка',
    'result.status.Pending': 'В ожидании',
    'result.status.Expired': 'Истек',
